...
reply_div.style.backgroundColor = 'rgba(0, 0, 0, 0.3)';
reply_div.style.top = '2px';
reply_div.innerHTML = '<svg viewBox="0 0 24 24" width="24" height="24" class=""><path fill="#ffffff" d="M9.72 7.43C17 8.47 20.5 13.3 21.93 18.48c.1.36-.36.59-.6.32-2.77-3.16-6.51-4.61-11.6-4.61v2.73c0 .72-.87 1.08-1.38.57L2.3 11.44a.809.809 0 0 1 0-1.15l6.05-6.05c.51-.51 1.38-.15 1.38.57v2.62z"></path></svg>';
